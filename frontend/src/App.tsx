...
type Page = 'dashboard' | 'signals' | 'chart' | 'trade' | 'demo' | 'autotrade' | 'autodemo' | 'scanner' | 'pnl' | 'analytics' | 'settings' | 'activate' | 'admin' | 'profile' | 'privacy' | 'terms' | 'help' | 'backtest' | 'copy' | 'social' | 'trader' | 'wallet';
        ...
        <main className="flex-1 min-h-0 overflow-auto px-2 sm:px-4 lg:px-6 py-4 pb-32 lg:pb-8">
          <Suspense fallback={
            ...
            <div key={safePage} className="animate-page-in max-w-[1440px] mx-auto flex flex-col gap-3">
              ...
              {safePage === 'autodemo' && <AutoDemoPage />}
