...
/** OKX: комиссия туда-обратно ~0.08–0.12%. Мин. дистанция TP от входа, чтобы прибыль покрывала комиссию + запас. */
export const MIN_TP_DISTANCE_PCT = 0.002;  // 0.2% — минимум, чтобы после ~0.1% комиссии оставался плюс
